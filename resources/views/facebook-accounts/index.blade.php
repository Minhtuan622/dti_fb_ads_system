<x-layouts.app :title="__('Tài khoản Facebook')">
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            ...
            <div>
                <flux:button href="{{ route('facebook-accounts.create') }}" variant="primary">
                    Thêm tài khoản
                </flux:button>
            </div>
        </div>
        ...
        <div class="mb-4 flex items-center space-x-4">
            <div class="w-64">
                ...
                <input type="text" id="searchInput" placeholder="Tìm theo tên hoặc ID..." class="w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm shadow-sm focus:border-blue-500 focus:outline-none dark:border-zinc-700 dark:bg-zinc-900 dark:text-white">
            </div>
            <div class="w-64">
                    ...
                    @foreach ($facebookAccounts as $acc)
                        <tr class="border-t">
                            ...
                            <td class="py-2 space-x-2">
                                <flux:button href="{{ route('facebook-accounts.edit', $acc) }}" variant="filled" size="xs">
                                    Sửa
                                </flux:button>
                                <flux:button onclick="confirmDeleteAccount('{{ $acc->id }}')" variant="danger" size="xs">
                                    Xóa
                                </flux:button>
                            </td>
                        </tr>
                ...
                <div class="inline-block transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left align-bottom shadow-xl transition-all dark:bg-zinc-800 sm:my-8 sm:w-full sm:max-w-lg sm:p-6 sm:align-middle">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            <h3 class="text-lg font-medium leading-6 text-gray-900 dark:text-white">Xóa tài khoản</h3>
                            <div class="mt-2">
        ...
        <script>
            function confirmDeleteAccount(id) {
                document.getElementById('deleteForm').action = `/facebook-accounts/${id}`;
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function filterAccounts() {
                    ...
                    tableRows.forEach(row => {
                        ...
                        const matchesSearch = accountId.includes(searchTerm) || name.includes(searchTerm);
